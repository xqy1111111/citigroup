...
本文主要由 ai 基于我们的代码生成，由于时间较晚未来得及修改，api 部分以 localhost:8000/docs 为准，这是 fastapi 提供的一个 util，非常好用
...
## 3. 安装 ollama，并且需要 pull ollama 的特定模型
...
然后可以在`localhost:8000/docs`访问项目，同时也可以进行 API 测试
